...
export default function Home() {
  ...
  return (
    <div>
        ...
        <div className="flex flex-col md:flex-row max-w-6xl mx-auto gap-10">
          <div className="w-full md:w-1/3">
            <div className="text-center items-center flex flex-col md:gap-4">
              <div className="flex rounded-full bg-slate-100 text-blue-500 w-16 h-16 items-center justify-center">
      ...
      <div className="bg-gradient-to-b from-white/0 to-slate-100">
        ...
        <div className="mx-auto my-0 max-w-6xl px-4 flex">
          <div className="p-2 md:p-8 flex w-full h-auto flex-col ">
            ...
            <p className="text-gray-500 text-xl pb-4">{/*subText*/}
            ...
            <div className="flex flex-wrap">{/*statsContainer*/}
              <div className="text-gray-500 basis-full max-w-full grow-0 md:max-w-1/3 md:basis-1/3 pt-4">{/*stats item */}
                <span className="text-4xl font-normal text-blue-500">{/*statsHeader*/}
              ...
              <div className="text-gray-500 basis-full max-w-full grow-0 md:max-w-1/3 md:basis-1/3 pt-4">
                <span className="text-4xl font-normal text-blue-500">
        ...
        <div className="mx-auto my-8 max-w-6xl px-4 flex">{/*margin*/}
          <div className="flex flex-wrap w-full gap-8 justify-center">{/*animatedCardsContainer*/}
            <BoxItem index={0}>
              <div className="rounded-lg h-full w-full p-8 bg-white shadow-lg">{/*animatedCardBackground*/}
