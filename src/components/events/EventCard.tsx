...
// import styles from "@/styles/Components/Events/EventCard.module.scss";
// import Link from "next/link";
// import { addMinutes, format, isSameDay } from "date-fns";
// import { ResponseState } from "@/lib/types/Events";
...
//         {...getReferenceProps()}
//         href={{ pathname: `/Events/${event._id}`, query: query }}
//         className={`${styles.card} ${localResponse === ResponseState.attending ? styles.attending : ""} ${localResponse === ResponseState.pending ? styles.invited : ""} ${
//           localResponse === ResponseState.declined ? styles.rejected : ""
//         } ${localResponse === ResponseState.hosting ? styles.hosting : ""}`}
//       >
...
//               <small>starts</small>
//             </div>
//             {!isDateEqual && <div className={styles.time}>{startDate}</div>}
...
//               <small>ends</small>
//             </div>
//             {!isDateEqual && <div className={styles.time}>{endDate}</div>}
...
//             </div>
//             <div className={styles.popoverPending}>
//               {" "}
//               <small className={styles.popoverCountHeading}>Pending</small>
//               {event.eventResponse.filter((r) => r.state === ResponseState.pending).length}
//             </div>
//           </div>
