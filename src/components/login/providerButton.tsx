...
const providerIcons = [
	{
		id: 'google',
		icon: <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className='w-6 h-6'>
	...
	{
		id: 'discord',
		icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 127.14 96.36" className='h-6 w-6'>
		...
		id: 'apple',
		icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className='h-6 w-6'>
...
export default function ProviderButton({ provider, children }: Props) {
	...
	return (
		<Button onClick={handleGoogleLogin} variant={"outline"} className='flex justify-evenly gap-2'>
			{providerIcon?.icon}{children}</Button>
	)
}